...
public class AlexandriaConfigTest {
    ...
    public void testLoadRemotesBaseUrl() throws IOException {
        ...
        AlexandriaConfig.RemoteConfig remoteConfig = config.remotes().get().get(0);
    ...
    public void testConfigSave() throws IOException {
        ...
        config.propertiesPath(folder.newFile().toPath());
        AlexandriaConfig.save(config);
        AlexandriaConfig reloaded = AlexandriaConfig.load(config.propertiesPath().toString());
